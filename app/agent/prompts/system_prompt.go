// Package prompts provides system prompt builders for AI agent.
package prompts
...
// BuildSystemPrompt creates the system prompt without user context.
...
- НЕ используй <br>, <p>, <div>, <span>, <ul>, <ol>, <li> и другие неподдерживаемые теги
