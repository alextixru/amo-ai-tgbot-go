...
type Service interface {
	// Customers
	ListCustomers(ctx context.Context, filter *filters.CustomersFilter, with []string) ([]models.Customer, error)
	GetCustomer(ctx context.Context, id int, with []string) (models.Customer, error)
