...
type Service interface {
	...
	// Catalog Elements
	ListElements(ctx context.Context, catalogID int) ([]*models.CatalogElement, error)
	GetElement(ctx context.Context, catalogID, elementID int) (*models.CatalogElement, error)
