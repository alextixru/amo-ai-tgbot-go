...
type Service interface {
	// Custom Fields
	ListCustomFields(ctx context.Context, entityType string) ([]*models.CustomField, error)
	...
	// Field Groups
	ListFieldGroups(ctx context.Context, entityType string) ([]models.CustomFieldGroup, error)
	GetFieldGroup(ctx context.Context, entityType string, id int) (*models.CustomFieldGroup, error)
	...
	// Loss Reasons
	ListLossReasons(ctx context.Context) ([]*models.LossReason, error)
	...
	UpdateLossReasons(ctx context.Context, reasons []*models.LossReason) ([]*models.LossReason, error)
